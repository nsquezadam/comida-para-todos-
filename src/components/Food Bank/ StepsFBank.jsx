        ...
        <div className="containerBoxDetails">
          ...
          <div className="boxContainerDetail">
            <div className="containerfood1">
              <img src={formulariocontacto} className="imgfoodDetail" alt={"Imagen"} />
            </div>
            <ul>
          ...
          <div className="boxContainerDetail">
            <div className="containerfood1">
              <img src={tiempoentrega} className="imgfoodDetail" alt={"Imagen"} />
            </div>
            <ul>
          ...
          <div className="boxContainerDetail">
            <div className="containerfood1">
              <img src={cajas} className="imgfoodDetail" alt={"Imagen"} />
            </div>
            <ul>
          ...
          <div className="boxContainerDetail">
            <div className="containerfood1">
              <img src={transportando} className="imgfoodDetail" alt={"Imagen"} />
            </div>
            <ul>
          ...
          <div className="boxContainerDetail">
            <div className="containerfood1">
              <img src={familia} className="imgfoodDetail" alt={"Imagen"} />
            </div>
            <ul>
